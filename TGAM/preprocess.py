...
# band filter of 0.5Hz-45Hz
def BandFilter(sig_data, sample_rate, lowcut=0.5, highcut=45, order=8):
...
def get_features(file_list, x1, x2, sample_rate):
    ...
    spE = np.column_stack((AE, SE, FE, PE))
    ...
    sp = np.column_stack((sp1, sp2, sp3, sp4, sp5, sp6, sp7, sp8, sp9, sp10, sp11, sp12, sp13, sp14, sp15))
